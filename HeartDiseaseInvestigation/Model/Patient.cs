...
namespace HeartDiseaseInvestigation.Model
{
    class Patient
    {
        ...
        public Patient(int age, int sex, int cp, int trestbps, int chol, int fbs, int restecg, int thalach, int exang, double oldpeak, int slope, int ca, int thal, int target)
        {
            this.age = age;
            this.sex = sex;
            this.cp = cp;
